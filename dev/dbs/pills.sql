...
CREATE TABLE `history` (
  ...
  `tid` int NOT NULL,
  KEY `tid_idx` (`tid`),
  CONSTRAINT `tid` FOREIGN KEY (`tid`) REFERENCES `tracks` (`id`)
...
CREATE TABLE `tracks` (
  ...
  KEY `pid_idx` (`pid`),
  KEY `did_idx` (`did`),
  CONSTRAINT `did` FOREIGN KEY (`did`) REFERENCES `drugs` (`id`),
  CONSTRAINT `pid` FOREIGN KEY (`pid`) REFERENCES `prescriptions` (`id`)
